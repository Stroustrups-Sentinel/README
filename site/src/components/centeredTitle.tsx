...
const CenteredTitle = (
{title, size="5rem", topChevron=false }: CenteredTitleProps
)  => {

    return (
        <div className="my-20">
            { topChevron ? <div className="my-10 justify-center flex">
                <img
            ...
            <span className="font-sans font-bold text-4xl md:text-8xl justify-center flex" >{title}</span>
        </div>
    );
};
