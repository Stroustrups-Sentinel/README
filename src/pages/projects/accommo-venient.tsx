...
const projectIndex: number = 1; //number from the bottom of the list in the `projects.json` file
...
const pageIndexes = getNextAndPrevIndexes(projectPosition, projects.length);
