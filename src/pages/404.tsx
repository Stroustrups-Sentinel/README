          ...
          <div className="bg-cloud-white dark:bg-p-black dark:text-white rounded-24 shadow p-4 border">
            ...
            <p className="p font-site-mono">
              ...
              <div className="flex place-items-center font-bold">
                ...
                <Link to={siteUrl}><button className="flex place-items-center py-2 pl-3 pr-4 primary-text rounded-24 dark-green-text font-site-mono  text-white navbar-gradient hover:outline hover:outline-black dark:hover:outline-gray-200">
